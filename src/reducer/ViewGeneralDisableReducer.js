...
function ViewGeneralDisableReducer(state, action) {
    ...
    } else if (type === "disable/playbackRate") {
    ...
    } else if (type === "disable/randomEndPoint") {
    ...
    } else if (type === "disable/randomStartPoint") {
    ...
    } else if (type === "enable/randomStartPoint") {
